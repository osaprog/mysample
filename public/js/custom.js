        ...
        $.post("../../blog/addcomment",  {
            ...
            function(data){
                if(data.response == true){
                    $stickynote.before("<div class=\"sticky-note\"><textarea class=\"customtextarea\" id=\"stickynote-"+data.new_comment_id+"\"></textarea><a href=\"#\" id=\"remove-"+data.new_comment_id+"\"class=\"delete-sticky\">X</a></div>");
